...
MedSegPy supports the Adam optimizer both with and without gradient accumulation. 
You are free to create your own optimizer, and write the training logic.
